...
int vaziaFilaFIFO(TipoFilaFIFO *f); /*retorna 1 se a fila *f estiver vazia; 0 caso contrário*/

void imprimeFilaFIFO(TipoFilaFIFO *f); /*imprime os itens da fila *f */

void apagaFilaFIFO(TipoFilaFIFO *f); /*libera a memória alocada pela fila *f, retirando todos os elementos
que houver */
